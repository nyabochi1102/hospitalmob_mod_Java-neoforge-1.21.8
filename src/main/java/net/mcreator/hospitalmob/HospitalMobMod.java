...
import net.mcreator.hospitalmob.init.HospitalMobModTabs;
import net.mcreator.hospitalmob.init.HospitalMobModItems;
import net.mcreator.hospitalmob.init.HospitalMobModEntities;
...
public class HospitalMobMod implements ModInitializer {
	public static final Logger LOGGER = LogManager.getLogger(HospitalMobMod.class);
	public static final String MODID = "hospital_mob";

	@Override
	public void onInitialize() {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		LOGGER.info("Initializing HospitalMobMod");
		HospitalMobModTabs.load();
		HospitalMobModEntities.load();
		HospitalMobModItems.load();
		tick();
